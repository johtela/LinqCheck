...
a very basic test first. Suppose we want to test the System.Math class. It is 
unlikely we find any bugs in it, but it is a simple static class that everyone
knows. Let's first write tests for the `Math.Max` method. 
